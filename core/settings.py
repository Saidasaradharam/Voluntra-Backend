...
SECRET_KEY = 'django-insecure-!#$xke^%kfxmc-#yce(5n6x*6o1brf-wu=a7zar*9c=#kslq=)'
...
# These are the methods allowed for CORS requests. Even if not specified, these are the defaults.
CORS_ALLOW_METHODS = [
    'DELETE',
    'GET',
    'OPTIONS',
